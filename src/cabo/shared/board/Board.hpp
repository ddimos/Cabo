...
public:
    ...
    void participantGrabs(PlayerId _playerId, BoardObjectId _id, sf::Vector2f _position);
    void participantReleases(PlayerId _playerId, BoardObjectId _id, sf::Vector2f _position);
    void participantMoves(PlayerId _playerId, sf::Vector2f _position);
    
private:
    BoardObjectId generateNextOjectId();
    BoardObject* getCard(BoardObjectId _id);
    ...
    BoardObjectId::Type m_objectIdGenerator = 0;
};
